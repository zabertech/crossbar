...
data = subprocess.check_output(['git', 'describe', '--tags', '--abbrev=0'])
__version__ = data.decode('utf8')[:-1]
...
setup(
    name='python-izaber-nexus',
    version=__version__,
    description='Nexus - Modified Crossbar.io multi-protocol (WAMP/WebSocket, REST/HTTP, MQTT) application router for microservices.',
    long_description=long_description,
    author='Crossbar.io Technologies GmbH, Zaber Technologies (some customizations) ',
